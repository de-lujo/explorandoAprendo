...
function texto0( event )
	...
	sonido=audio.loadStream("music/cuento1/Parrafo 3.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto1( event )
	...
	contador=3
	sonido=audio.loadStream("music/cuento1/Parrafo 4.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto3( event )
	...
	contador=4
	sonido=audio.loadStream("music/cuento1/Parrafo 5.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
