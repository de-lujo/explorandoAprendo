...
function scene:createScene( event )
	...
	fondo=display.newImage("img/cu02.png",1024,600)
	...
	text1 = display.newText("Caminaron, caminaron y siguieron caminando, cuando".. "\nde pronto ¡PLAP, Qué sorpresa, una cebra en el camino!" , 0, 0, native.systemFont, 18 )
...
function texto0( event )
	...
	text1.text="Caminaron, caminaron y siguieron caminando, cuando".. "\nde pronto ¡PLAP, Qué sorpresa, una cebra en el camino!"
	transition.fadeIn( text1, {time=1000} )
	contador=2
	channel=audio.findFreeChannel()
	sonido=audio.loadStream("music/cuento1/Parrafo 3.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
...
function texto1( event )
	...
	contador=3
	sonido=audio.loadStream("music/cuento1/Parrafo 4.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
	text1.text= "¡Qué lindas tus rayas blancas y negras!\nNosotros también queremos tenerlas.\n\nCreo que para tenerlas tendrán que pintarlas\nya que nunca, nunca podrán encontrarlas.\n¡Está bien!"
	transition.fadeIn( text1, {time=1000} )
...
function texto3( event )
	...
	audio.play(sonido)
	text1.text="Cocodrilo e Hipopótamo pintaron sus rayas\ny siguieron su camino."
	transition.fadeIn( text1, {time=1000} )
...
function scene:exitScene( event )
   ...
   cancelAll(event)
   storyboard.removeScene("sabanaCuento2")
