...
function scene:createScene( event )
	...
	text1= display.newText("Caminaron, caminaron y siguieron caminando,".. "\ncuando de pronto… ¡PLAP! ¡PLEP! ¡PLIP! ¡PLOP!".."\nCocodrilo e hipopótamo cruzaron sus miradas", 0, 0, native.systemFont, 18 )
...
function texto2( event )
	...
	text1.text= "y rieron y rieron por un largo rato y felices con".. "\nsus rayas, cuernos y plumas, regresaron a su hogar" .. "\npensando en cuál sería su próxima aventura."
	transition.fadeIn( text1, {time=1000} )
