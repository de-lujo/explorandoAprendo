...
function texto0( event )
	...
	sonido=audio.loadStream("music/cuento2/Parrafo 10.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto1( event )
	...
	contador=3
	sonido=audio.loadStream("music/cuento2/Parrafo 10_2.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
