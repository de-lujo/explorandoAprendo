...
function texto0( event )
	...
	text1.text="Al día siguiente, fue el turno del grandísimo Rinoceronte:"
	transition.fadeIn( text1, {time=1000} )
	contador=2
	--channel=audio.findFreeChannel()
	sonido=audio.loadStream("music/cuento2/Parrafo 8.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto1( event )
	...
	sonido=audio.loadStream("music/cuento2/Parrafo 9.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
	text1.text= "En la mañana despertó con su cuerno pintado\ny lleno de flores, lo que lo hizo gritar por montones:\n\n¡WAAAAAAAAAAA!"
	transition.fadeIn( text1, {time=1000} )
