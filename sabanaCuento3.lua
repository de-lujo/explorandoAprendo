...
local fondo, boton, icono, explorador, planeta, titulo, screenGroup, text, sonido
local time={}
...
function scene:createScene( event )
	...
	fondo=display.newImage("img/cu03.png",1024,600)
	...
	text1 = display.newText("Cocodrilo e Hipopótamo pintaron sus rayas".."\ny siguieron su camino. Caminaron, caminaron".."\ny siguieron caminando, cuando de pronto" .. "\n\n¡PLAP! ¡PLEP! un Ñu en el camino.", 0, 0, native.systemFont, 18 )
...
function texto2( event )
	...
	text1.text= "Creo que para tenerlos, tendrán que hacerlos,".. "\n\nya que nunca, nunca podrán poseerlos." .. "\n¡Está bien!"
	transition.fadeIn( text1, {time=1000} )
...
function scene:enterScene( event)
	...
	sonido=audio.loadStream("music/cuento1/Parrafo 5.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
...
function scene:exitScene( event )
   ...
   storyboard.removeScene("sabanaCuento3")
