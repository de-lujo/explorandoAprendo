...
local dicci, nota,screenGroup,text1
local time={}
local sonido, palabra
...
function texto1( event )
	...
	sonido=audio.loadStream("music/cuento2/Parrafo 2.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
	text1.text= "Primero fue el turno del mismísimo rey de la sabana," .. "\nel León: Una mañana despertó con su hermosa y " .. "\nabundante melena llena de nudos por todas partes,"
...
function texto2( event )
	...
	audio.play(sonido)
	text1.text= "lo que lo hizo rugir de forma muy agobiante:".. "\n¡¡GRAWRRRR!! " .. "\n\n(Mientras tanto, las hienas se reían: ¡JIJIJI!)"
	transition.fadeIn( text1, {time=1000} )
