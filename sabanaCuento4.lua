...
function scene:createScene( event )
	...
	fondo=display.newImage("img/cu04.png",1024,600)
...
function texto0( event )
	...
	sonido=audio.loadStream("music/cuento1/Parrafo 9.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto1( event )
	...
	contador=3
	--channel= audio.findFreeChannel()
	sonido=audio.loadStream("music/cuento1/Parrafo 10.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto3( event )
	...
	contador=4
	--channel= audio.findFreeChannel()
	sonido=audio.loadStream("music/cuento1/Parrafo 11.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
