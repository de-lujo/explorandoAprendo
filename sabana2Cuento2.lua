...
function scene:createScene( event )
	...
	text1 = display.newText("Al día siguiente,\nfue el turno de la elegante Jirafa:" , 0, 0, native.systemFont, 18 )
...
function texto0( event )
	...
	text1.text="Al día siguiente, fue el turno de la elegante Jirafa:"
	transition.fadeIn( text1, {time=1000} )
	contador=2
	channel=audio.findFreeChannel()
	sonido=audio.loadStream("music/cuento2/Parrafo 4.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
...
function texto1( event )
	...
	sonido=audio.loadStream("music/cuento2/Parrafo 5.mp3", {loops = -1, channel = channel})
	audio.play(sonido)
	text1.text= "En la mañana despertó con sus largas y delgadas\npatas todas atadas, lo que la hizo llorar de forma\ndesesperada: ¡PIPIPIPIPI!\n\n(Mientras tanto, las hienas se reían: ¡JIJIJI!)"
	transition.fadeIn( text1, {time=1000} )
...
function scene:exitScene( event )
   ...
   cancelAll(event)
   storyboard.removeScene("sabana2Cuento2")
