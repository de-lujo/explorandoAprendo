...
local dicci, nota,screenGroup,text, sonido
...
function scene:createScene( event )
	...
	text1 = display.newText("Al día siguiente, fue el turno de la elegante Jirafa:".. "\n\nEn la mañana despertó con sus largas y" .. "\ndelgadas patas todas atadas", 0, 0, native.systemFont, 18 )
...
function texto1( event )
	...
	audio.play(sonido)
	text1.text= "lo que la hizo llorar de forma desesperada: ¡PIPIPIPIPI!" .. "\n\n(Mientras tanto, las hienas se reían: ¡JIJIJI!)"
