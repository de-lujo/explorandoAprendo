...
function scene:createScene( event )
	...
	fondo=display.newImage("img/cu203.png",1024,600)
	...
	text1= display.newText("Al día siguiente, fue el turno del imponente Elefante:".. "\n\nEn la mañana despertó con un gran y fuerte nudo".. "\nen su trompa", 0, 0, native.systemFont, 18 )
...
function texto1( event )
	...
	audio.play(sonido)
	text1.text= "lo que lo hizo enojar de una y mil formas: ¡JUUUUUUUM! " .. "\n\n(Mientras tanto, las hienas se reían: ¡JIJIJI!)"
...
function scene:exitScene( event )
   ...
   storyboard.removeScene("sabana2Cuento3")
