...
function texto0( event )
	...
	sonido=audio.loadStream("music/cuento1/Parrafo 1.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto1( event )
	...
	contador=3
	sonido=audio.loadStream("music/cuento1/Parrafo 1_2.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
...
function texto2( event )
	...
	sonido=audio.loadStream("music/cuento1/Parrafo 2.mp3", {loops = -1, channel = _G.channel2})
	audio.play(sonido)
