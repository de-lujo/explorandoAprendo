...
function scene:createScene( event )
	...
	--text1= display.newText("Ernestino es un cocodrilo que vive en la Sabana,\nsu casa es un refrescante lago, el cual comparte\ncon su amigo Agustín, el hipopótamo\na ambos les encanta pasar largas horas en el agua," .. "\ny de vez en cuando les gusta tomar el sol" .. "\nacostados a orillas del lago. Un día, aburridos de hacer\nsiempre lo mismo y con deseos de vivir nuevas aventuras,".. "\ndecidieron salir a caminar, pasear y conocer el mundo.", 0, 0, native.systemFont, 18 )
	text1= display.newText("Ernestino es un cocodrilo que vive en la Sabana,".. "\nsu casa es un refrescante lago, el cual comparte" .. "\ncon su amigo Agustín, el hipopótamo", 0, 0, native.systemFont, 18 )
